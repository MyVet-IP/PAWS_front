...
export function NavbarController() {
    ...
    return `
    <nav class="bg-white/80 backdrop-blur-md border-b border-gray-100 px-4 lg:px-8 py-3 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex items-center justify-between">

            <!-- Logo -->
            <a 
                href="#/" 
                class="flex items-center gap-2 font-poppins font-bold text-text-primary hover:opacity-80 transition"
            >
            ...
            <div class="hidden md:flex items-center gap-1">
                <a href="#/clinics" class="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-text-soft hover:text-text-primary hover:bg-paws-green/20 transition">
                ...
                <a href="#/services" class="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-text-soft hover:text-text-primary hover:bg-paws-purple/20 transition">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#/tips" class="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-text-soft hover:text-text-primary hover:bg-paws-yellow/30 transition">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="hidden lg:flex items-center">
                <div class="relative">
                    ...
                    <input 
                        ...
                        class="w-64 pl-10 pr-4 py-2 bg-surface-muted border border-gray-200 rounded-full text-sm placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-paws-purple/30 focus:border-paws-purple transition"
                    />
                </div>
            </div>
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="md:hidden hidden mt-4 pb-4 border-t border-gray-100 pt-4">
